...
export default function Experience() {
  ...
  return (
    <>
      <Head>
        <title>Experience | Edem KPOMACHI </title>
        <meta
          name="description"
          content="Minha experiência como desenvolvedor web."
        />
        <meta property="og:title" content="Experience | Edem KPOMACHI" />
        <meta
      ...
      <Section>
        ...
        I am keen to improve my skills and learn new technologies.
        I am always open to new challenges and stimulating projects.
